...
export default function Menu() {
  ...
  return (
    <Popover>
      <PopoverTrigger className="fixed bottom-5 right-5 z-10 flex h-8 w-8 items-center justify-center rounded-lg transition-colors duration-200 hover:bg-stone-100 active:bg-stone-200 sm:bottom-auto sm:top-5">
